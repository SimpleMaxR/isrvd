...
func (app *App) defineApisixRoutes() []Route {
	return []Route{
		// Route 管理
		{Method: "GET", Path: "/apisix/routes", Handler: app.apisixRouteList, Module: "apisix", Label: "查询 APISIX 路由列表", Permission: "apisix.route.list"},
		{Method: "GET", Path: "/apisix/route/:id", Handler: app.apisixRouteInspect, Module: "apisix", Label: "获取 APISIX 路由详情", Permission: "apisix.route.inspect"},
		{Method: "POST", Path: "/apisix/route", Handler: app.apisixRouteCreate, Module: "apisix", Label: "创建 APISIX 路由", Permission: "apisix.route.create"},
		{Method: "PUT", Path: "/apisix/route/:id", Handler: app.apisixRouteUpdate, Module: "apisix", Label: "更新 APISIX 路由", Permission: "apisix.route.update"},
		{Method: "PATCH", Path: "/apisix/route/:id/status", Handler: app.apisixRouteStatusPatch, Module: "apisix", Label: "切换 APISIX 路由状态", Permission: "apisix.route.status"},
		{Method: "DELETE", Path: "/apisix/route/:id", Handler: app.apisixRouteDelete, Module: "apisix", Label: "删除 APISIX 路由", Permission: "apisix.route.delete"},
		// Consumer 管理
		{Method: "GET", Path: "/apisix/consumers", Handler: app.apisixConsumerList, Module: "apisix", Label: "查询 APISIX 消费者列表", Permission: "apisix.consumer.list"},
		{Method: "POST", Path: "/apisix/consumer", Handler: app.apisixConsumerCreate, Module: "apisix", Label: "创建 APISIX 消费者", Permission: "apisix.consumer.create"},
		{Method: "PUT", Path: "/apisix/consumer/:username", Handler: app.apisixConsumerUpdate, Module: "apisix", Label: "更新 APISIX 消费者", Permission: "apisix.consumer.update"},
		{Method: "DELETE", Path: "/apisix/consumer/:username", Handler: app.apisixConsumerDelete, Module: "apisix", Label: "删除 APISIX 消费者", Permission: "apisix.consumer.delete"},
		// 白名单
		{Method: "GET", Path: "/apisix/whitelist", Handler: app.apisixWhitelistInspect, Module: "apisix", Label: "查询 APISIX 白名单", Permission: "apisix.whitelist.inspect"},
		{Method: "POST", Path: "/apisix/whitelist", Handler: app.apisixWhitelistCreate, Module: "apisix", Label: "配置 APISIX 路由白名单", Permission: "apisix.whitelist.create"},
		{Method: "POST", Path: "/apisix/whitelist/user", Handler: app.apisixWhitelistUserCreate, Module: "apisix", Label: "新建用户并加入 APISIX 白名单", Permission: "apisix.whitelist.user.create"},
		{Method: "DELETE", Path: "/apisix/whitelist/user/:routeID/:consumerName", Handler: app.apisixWhitelistUserDelete, Module: "apisix", Label: "从 APISIX 白名单移除用户", Permission: "apisix.whitelist.user.delete"},
		// PluginConfig 管理
		{Method: "GET", Path: "/apisix/plugin-configs", Handler: app.apisixPluginConfigList, Module: "apisix", Label: "查询 APISIX 插件配置列表", Permission: "apisix.plugin-config.list"},
		{Method: "GET", Path: "/apisix/plugin-config/:id", Handler: app.apisixPluginConfigInspect, Module: "apisix", Label: "获取 APISIX 插件配置详情", Permission: "apisix.plugin-config.inspect"},
		{Method: "POST", Path: "/apisix/plugin-config", Handler: app.apisixPluginConfigCreate, Module: "apisix", Label: "创建 APISIX 插件配置", Permission: "apisix.plugin-config.create"},
		{Method: "PUT", Path: "/apisix/plugin-config/:id", Handler: app.apisixPluginConfigUpdate, Module: "apisix", Label: "更新 APISIX 插件配置", Permission: "apisix.plugin-config.update"},
		{Method: "DELETE", Path: "/apisix/plugin-config/:id", Handler: app.apisixPluginConfigDelete, Module: "apisix", Label: "删除 APISIX 插件配置", Permission: "apisix.plugin-config.delete"},
		// Upstream 管理
		{Method: "GET", Path: "/apisix/upstreams", Handler: app.apisixUpstreamList, Module: "apisix", Label: "查询 APISIX 上游列表", Permission: "apisix.upstream.list"},
		{Method: "GET", Path: "/apisix/upstream/:id", Handler: app.apisixUpstreamInspect, Module: "apisix", Label: "获取 APISIX 上游详情", Permission: "apisix.upstream.inspect"},
		{Method: "POST", Path: "/apisix/upstream", Handler: app.apisixUpstreamCreate, Module: "apisix", Label: "创建 APISIX 上游", Permission: "apisix.upstream.create"},
		{Method: "PUT", Path: "/apisix/upstream/:id", Handler: app.apisixUpstreamUpdate, Module: "apisix", Label: "更新 APISIX 上游", Permission: "apisix.upstream.update"},
		{Method: "DELETE", Path: "/apisix/upstream/:id", Handler: app.apisixUpstreamDelete, Module: "apisix", Label: "删除 APISIX 上游", Permission: "apisix.upstream.delete"},
		// SSL 管理
		{Method: "GET", Path: "/apisix/ssls", Handler: app.apisixSSLList, Module: "apisix", Label: "查询 APISIX 证书列表", Permission: "apisix.ssl.list"},
		{Method: "GET", Path: "/apisix/ssl/:id", Handler: app.apisixSSLInspect, Module: "apisix", Label: "获取 APISIX 证书详情", Permission: "apisix.ssl.inspect"},
		{Method: "POST", Path: "/apisix/ssl", Handler: app.apisixSSLCreate, Module: "apisix", Label: "创建 APISIX 证书", Permission: "apisix.ssl.create"},
		{Method: "PUT", Path: "/apisix/ssl/:id", Handler: app.apisixSSLUpdate, Module: "apisix", Label: "更新 APISIX 证书", Permission: "apisix.ssl.update"},
		{Method: "DELETE", Path: "/apisix/ssl/:id", Handler: app.apisixSSLDelete, Module: "apisix", Label: "删除 APISIX 证书", Permission: "apisix.ssl.delete"},
		// 插件列表
		{Method: "GET", Path: "/apisix/plugins", Handler: app.apisixPluginList, Module: "apisix", Label: "查询 APISIX 插件列表", Permission: "apisix.plugin.list"},
	}
}
